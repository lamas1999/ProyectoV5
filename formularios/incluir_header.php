...
<html lang="es">
  <head>
    ...
    <!--  -->
    <link rel="icon" href="../assets/img/iconop.png">
    <!-- Font-icon css-->
     ...
     <!--    <li class="app-search">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="frmperfil.php"><i class="fa fa-user fa-lg"></i> Perfil</a></li>
            <li><a class="dropdown-item" href="frmcerrarseccion.php"><i class="fa fa-sign-out fa-lg"></i>Cerrar Seccion</a></li>
          </ul>
        </li>
      </ul>
    </header>